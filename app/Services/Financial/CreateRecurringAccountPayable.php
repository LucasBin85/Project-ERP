...
class CreateRecurringAccountPayable
{
    ...
    public function execute(
        ...
        if ($dto->type !== 'payable') {
            throw ValidationException::withMessages(['type' => 'A recorrência deve ser do tipo a pagar.']);
        }
        ...
        return DB::transaction(function () use ($wallet, $dto, $period, $actualAmountCents, $dueDate, $notes) {
            ...
            return $expectation->fresh(['occurrences.accountPayable']);
        });
    }
