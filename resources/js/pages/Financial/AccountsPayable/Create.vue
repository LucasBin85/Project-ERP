        ...
        <ReportPage title="Nova conta a pagar" :subtitle="wallet.name">
            <ReportSection>
                ...
                <form class="grid grid-cols-1 gap-4 p-6 md:grid-cols-2" @submit.prevent="submit">
                    ...
                    <div><label class="mb-1 block text-sm font-semibold text-gray-300">Forma de pagamento</label><select v-model="accountPayable.form.mode" class="w-full rounded-lg border border-gray-700 bg-black px-3 py-2 text-white"><option value="single">À vista</option><option value="installment">Parcelado</option></select></div>
