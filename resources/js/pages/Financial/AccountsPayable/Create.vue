            ...
            <ReportSection>
                ...
                <form class="grid grid-cols-1 gap-4 p-6 md:grid-cols-2" @submit.prevent="submit">
                    ...
                    <div v-if="accountPayable.form.mode === 'recurring'" class="md:col-span-2 grid grid-cols-1 gap-4 rounded-lg border border-gray-700 bg-gray-950 p-4 md:grid-cols-2">
                        ...
                        <p v-if="accountPayable.form.recurring_amount_mode === 'variable'" class="md:col-span-2 text-sm text-gray-400">Para valores variáveis, o sistema utilizará o histórico das últimas contas confirmadas para estimar as próximas competências. Você pode informar uma previsão inicial opcional.</p>
                    </div>
